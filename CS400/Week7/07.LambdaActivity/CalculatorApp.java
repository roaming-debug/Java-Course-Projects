...
public class CalculatorApp {
    ...
    public static MathOperation add() {
        // Define a class named AdditionOperation that implements
    ...
    public static MathOperation sub() {
        // Return a new instance of an anonymous class that implements
    ...
    public static MathOperation mul() {
        // Use a lambda expression on the line below to create and
