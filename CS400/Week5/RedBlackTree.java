...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        ...
        if(child == null || parent == null ||
                (!parent.leftChild.equals(child) && !parent.rightChild.equals(child))) {
    ...
    /**
     * Test rotation method if the invalid data would be detected
    ...
    public static boolean test1() {
        ...
        tree.insert(7);
        try {
            tree.rotate(tree.root.leftChild, null);
            return false;
        ...
        try {
            tree.rotate(null, tree.root.leftChild);
            return false;
        } catch (IllegalArgumentException iae) {
            // expected behaviour
        } catch (Exception e) {
        ...
        try {
            tree.rotate(tree.root, tree.root.leftChild);
            return false;
        } catch (IllegalArgumentException iae) {
            // expected behaviour
        } catch (Exception e) {
    ...
    /**
     * Test rotate method if the parent is the root of the tree
     * @return true if no bugs detected, otherwise false
     */
    public static boolean test2() {
        ...
        try {
            ...
            if(!tree.toLevelOrderString().equals("[ 6, 4, 7, 2, 5, 1, 3 ]") || !tree.toInOrderString().equals("[ 1, 2, 3, 4, 5, 6, 7 ]"))
                return false;
        } catch (Exception e) {
            return false;
        }
    ...
    public static boolean test3() {
        ...
        try {
            ...
            if(!tree.toLevelOrderString().equals("[ 4, 1, 6, 2, 5, 7, 3 ]") || !tree.toInOrderString().equals("[ 1, 2, 3, 4, 5, 6, 7 ]"))
                return false;
            tree = new RedBlackTree<>();
            tree.insert(4);
            tree.insert(2);
            ...
            if(!tree.toLevelOrderString().equals("[ 4, 2, 7, 1, 3, 6, 5 ]") || !tree.toInOrderString().equals("[ 1, 2, 3, 4, 5, 6, 7 ]"))
                return false;
        } catch (Exception e) {
            return false;
        }
